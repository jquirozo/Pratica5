...
/*function leerContactos(){
	navigator.contacts.find(["*"],function(contactos){
		...
		for(i=0;i<contactoss.lenght;i++){
				var contactoo=contactoss[i];
				ListaContactos += '<li><a href="tel://'+contactoo.phoneNumbers[0].value+'">'+contactoo.name.formatted+'</a></li>';
				$('#contactsList').html(ListaContactos);//agregamos la lista al id de HTML
			}
		},function(){
